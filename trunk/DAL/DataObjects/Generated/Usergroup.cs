...
namespace DataObjectsDAL
{
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the usergroups table.
	/// </summary>
	[Serializable]
	public partial class Usergroup : ActiveRecord<Usergroup>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("usergroups", TableType.Table, DataService.GetInstance("AceMail"));
				...
				DataService.Providers["AceMail"].AddSchema("usergroups",schema);
			}
		}
		#endregion
		...
		/// </summary>
		public static void Insert(string varUserid,string varGroupid)
		{
		...
		/// </summary>
		public static void Update(string varUserid,string varGroupid)
		{
			Usergroup item = new Usergroup();
