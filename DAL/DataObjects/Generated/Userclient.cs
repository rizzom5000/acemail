...
{
	/// <summary>
	/// Strongly-typed collection for the Userclient class.
	/// </summary>
    [Serializable]
	public partial class UserclientCollection : ActiveList<Userclient, UserclientCollection>
	{	   
        ...
        /// </summary>
        /// <returns>UserclientCollection</returns>
		public UserclientCollection Filter()
        {
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the userclients table.
	/// </summary>
	[Serializable]
	public partial class Userclient : ActiveRecord<Userclient>, IActiveRecord
	{
		...
		public Userclient(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public Userclient(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public Userclient(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("userclients", TableType.Table, DataService.GetInstance("AceMail"));
				...
				DataService.Providers["AceMail"].AddSchema("userclients",schema);
			}
		}
		#endregion
		...
		/// </summary>
		public static void Insert(string varUserid,string varClientid)
		{
		...
		/// </summary>
		public static void Update(string varUserid,string varClientid)
		{
			Userclient item = new Userclient();
